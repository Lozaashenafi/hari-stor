    ...
    <div className="space-y-10 pb-20 px-2 md:px-0">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          ...
          <p className="text-[#C5A059] text-xs uppercase tracking-[0.5em] mt-4 font-black">
            Inventory Archives
          </p>
        </div>
        ...
        <Link 
          ...
          className="w-full md:w-auto bg-[#C5A059] text-black px-10 py-5 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-[#D4B26E] transition-all text-center shadow-2xl shadow-gold/20"
        >
          + Create Masterpiece
        </Link>
      </div>
